...
def build_json(root_path, file_name):
...
def main(nfs_path,capture_format):
				...
				if(len(inner_dir_list) > 0):
					for indir in inner_dir_list:
						...
						if(capture_check):
							...
							try:
								build_json(root_path, file_name)
							except Exception as e:
								print("Exception", str(e))
...
if __name__ == "__main__":
	...
	profile_parser.add_argument('capture_format', metavar='project name', type=str, help='define the project name (eg: PB, PSFF, iPCM )')
