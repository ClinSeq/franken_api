...
def build_qc(root_path):
    ...
    return qc_df_data.to_json(orient = 'index')
...
def main(root_path, file_name):
    ...
    # Sample Information
    project_json["sample"] = {"identifier": "NA",  "sample_date": "NA", "seq_date": "NA", "birthdate": "NA", "hospital": "NA", "cancer_taxonomy": "NA", "cancer_acronym": "NA", "tissue_source": "NA", "tissue_type": "NA", "pathology_ccf": "NA", "bioinf_ccf": "NA", "germline_dna": "NA"}
    ...
    qc_json = build_qc(root_path)
    project_json["qc"] = json.loads(qc_json)
    logging.info('--- QC completed ---')
    
    # Phenotype
    project_json["phenotypes"] = {"ploidy": "NA", "msi": "NA",  "hrrd":"NA",  "tmb": { "value": "NA", "unit": "muts/Mb", "method": "Johan L. et al NEJM 2021"}}
    ...
    project_json["cnvs"] = json.loads(cnv_json)
                ...
                if(len(inner_dir_list) > 0):
                    for indir in inner_dir_list:
                        ...
                        if(capture_check):
                            ...
                            output_path = root_path+"/report";
                            file_name = output_path+"/MTBP_PSFF_SI_PI_CFDNA"+cfdna+".json"
                            log_name = output_path+"/MTBP_PSFF_SI_PI_CFDNA"+cfdna+".log"
