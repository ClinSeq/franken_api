...
This module defines serializers for the Franken API project.
It includes schema definitions and data validation logic for API endpoints.
"""
...
status_result = api.model(
    "server status", {"server_status": fields.Boolean(default=False, required=True)}
)

list = fields.String() # pylint: disable=redefined-builtin

dropdownlist = api.model(
    "Dropdown list for sample ids ",
    {"sidis": fields.List(list), "status": fields.Boolean(required=True)},
)
dropdownlist_capture = api.model(
    "Dropdown list for capture ids ",
    {"sample_capture": fields.List(list), "status": fields.Boolean(required=True)},
)

ploturl_list = api.model(
    "List the rul for static franken plots",
    {"image_url": fields.List(list), "status": fields.Boolean(required=True)},
)

probio_ref_data = api.model(
    "ProbioBloodReferral",
    {
...
header = api.model(
    "Probio header",
    {
        "key": fields.String(description="Column name"),
        "title": fields.String(description="Column display name"),
    },
)

probio_ref_data_list = api.model(
    "Referral DB Data",
    {
        "status": fields.Boolean(required=True),
        "data": fields.List(fields.Nested(probio_ref_data)),
        "header": fields.List(fields.Nested(header)),
        "error": fields.String(),
    },
)


header_psff = api.model(
    "Psff header",
    {
        "key": fields.String(description="Column name"),
        "title": fields.String(description="Column display name"),
...
psff_ref_data_list = api.model(
    "Referral DB Data",
    {
        "status": fields.Boolean(required=True),
        "data": fields.List(fields.Nested(psff_ref_data)),
        "header": fields.List(fields.Nested(header_psff)),
        "error": fields.String(),
    },
)


referral_db_out = api.model(
    "Referral DB update",
    {"status": fields.Boolean(required=True), "error": fields.String()},
)

curation_germline = api.model(
    "IGV Germline",
    {
...
curation_cancer_hotspot = api.model(
    "IGV Cancer Hotspot",
    {
...
curation_psff_profile = api.model(
    "PSFF Profile",
    {
        "id": fields.String(description=""),
...
curation_probio_profile = api.model(
    "PROBIO Profile",
    {
        "id": fields.String(description=""),
        "sample_id": fields.String(description=""),
...
curation_genomic_profile = api.model(
...
germline_data_list = api.model(
    "Curation Germline DB Data",
    {
        "status": fields.Boolean(required=True),
...
somatic_data_list = api.model(
    "Curation Somatic DB Data",
    {
        "status": fields.Boolean(required=True),
...
svs_data_list = api.model(
    "Curation SVS DB Data",
    {
        "status": fields.Boolean(required=True),
...
hotspot_data_list = api.model(
    "Curation Hotspot DB Data",
    {
        "status": fields.Boolean(required=True),
...
cancer_hotspot_data_list = api.model(
    "Curation Cancer Hotspot DB Data",
    {
        "status": fields.Boolean(required=True),
...
warmspot_data_list = api.model(
    "Curation Warmspot DB Data",
    {
        "status": fields.Boolean(required=True),
...
psff_profile_data_list = api.model(
    "Curation PSFF Profile DB Data",
    {
        "status": fields.Boolean(required=True),
...
probio_profile_data_list = api.model(
    "Curation PROBIO Profile DB Data",
    {
        "status": fields.Boolean(required=True),
...
genomic_profile_data_list = api.model(
    "Curation Genomic Profile DB Data",
    {
        "status": fields.Boolean(required=True),
