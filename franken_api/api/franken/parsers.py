...
This module defines and configures Flask-RESTX request parsers for API endpoints.

Each parser validates incoming request parameters for the associated endpoint(s),
including required fields, data types, default values, and help messages.
"""

from flask_restx import reqparse

project_arguments = reqparse.RequestParser()
project_arguments.add_argument(
    "project_name",
    required=True,
    help="valid Project names: 'PROBIO', 'PSFF', 'LARS_DUCTAL', 'AZ_RINGTRIAL', msHSPC', 'RESBIO', 'HD_C3', 'LPC', 'CHEERS', 'ULLEN', 'CRC_REFLEX', 'IPCM', 'EVAL_SAMPLES', 'Course-PROBIO",
)

capture_arguments = reqparse.RequestParser()
capture_arguments.add_argument(
    "project_name",
    required=True,
...
capture_arguments.add_argument(
    "sdid", type=str, required=True, help="sdid example : P-00360714"
)
...
purecn_max_val_arguments.add_argument(
    "variant_type",
...
staticplot_arguments.add_argument(
    "imagename", type=str, required=True, help="static franken plot name"
)

table_svs_arguments = common_arguments.copy()
table_svs_arguments.add_argument("uId", type=str, required=True, help="user id")
table_svs_arguments.add_argument(
    "header",
    choices=("true", "false"),
    default="true",
    required=True,
    help="Boolen True or False : True returns only column header",
)
...
igv_save_file_arguments.add_argument(
    "file_name", required=True, help="igvnav-input.txt as File Name  "
)
...
referral_update_arguments.add_argument(
    "db_name",
    choices=("probio", "psff"),
    required=True,
...
referral_db_arguments.add_argument(
    "filter_option",
    required=True,
...
curation_germline_arguments.add_argument("ASSESSMENT", type=str, help="")
curation_germline_arguments.add_argument("zygosity", type=str, help="")
...
curation_germline_arguments.add_argument(
    "include_variant_report_pdf", type=str, help=""
)
...
curation_somatic_arguments.add_argument("SECONDHIT", type=str, help="")
...
curation_psff_profile_arguments.add_argument(
    "sample_id", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "capture_id", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "basic_qc", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "franken_plot", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument("ploidy", type=str, required=True, help="")
curation_psff_profile_arguments.add_argument(
    "ctdna_fraction", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "ctdna_param", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "ctdna_method", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "study_code", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "study_site", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "somatic_mutations", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "germline_alterations", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument(
    "structural_variants", type=str, required=True, help=""
)
curation_psff_profile_arguments.add_argument("cnvs", type=str, required=True, help="")
curation_psff_profile_arguments.add_argument(
    "comment_info", type=str, required=True, help=""
)

curation_psff_profile_id_arguments = reqparse.RequestParser()
curation_psff_profile_id_arguments.add_argument(
    "sample_id", type=str, required=True, help=""
)


curation_probio_profile_arguments = reqparse.RequestParser()
curation_probio_profile_arguments.add_argument(
    "sample_id", type=str, required=True, help=""
)
curation_probio_profile_arguments.add_argument(
    "capture_id", type=str, required=True, help=""
...
curation_probio_profile_arguments.add_argument(
    "ploidy", type=str, required=True, help=""
)
curation_probio_profile_arguments.add_argument(
    "ctdna_fraction", type=str, required=True, help=""
)
...
curation_probio_profile_arguments.add_argument(
    "ctdna_category", type=str, required=True, help=""
)
curation_probio_profile_arguments.add_argument(
    "study_code", type=str, required=True, help=""
)
...
curation_genomic_profile_arguments.add_argument(
    "project_name", type=str, required=True, help=""
)
curation_genomic_profile_arguments.add_argument(
    "sample_id", type=str, required=True, help=""
)
...
curation_genomic_profile_arguments.add_argument(
    "disease", type=str, required=True, help=""
)
curation_genomic_profile_arguments.add_argument(
    "specimen_assay", type=str, required=True, help=""
)
curation_genomic_profile_arguments.add_argument(
    "ctdna_param", type=str, required=True, help=""
)
...
curation_genomic_profile_arguments.add_argument(
    "genome_wide", type=str, required=True, help=""
)
curation_genomic_profile_arguments.add_argument(
    "somatic_mutations", type=str, required=True, help=""
)
...
curation_genomic_profile_arguments.add_argument(
    "cnvs", type=str, required=True, help=""
)
curation_genomic_profile_arguments.add_argument(
    "summary_txt", type=str, required=True, help=""
)

curation_probio_profile_id_arguments = reqparse.RequestParser()
curation_probio_profile_id_arguments.add_argument(
    "sample_id", type=str, required=True, help=""
)
...
auth_register_arguments.add_argument(
    "first_name", type=str, required=True, help="Please provide the first name"
)
auth_register_arguments.add_argument(
    "last_name", type=str, required=True, help="Please provide the last name"
)
auth_register_arguments.add_argument(
    "email_id", type=str, required=True, help="Enter valid email id format"
)
auth_register_arguments.add_argument(
    "passwd",
    type=str,
    required=True,
    help="Password contains atleast 6 letters with alpha-numeric and special characters",
)
auth_register_arguments.add_argument(
    "proj_ids", type=str, required=True, help="Please provide project ids eg: 1,2"
)
...
update_curated_info_arguments.add_argument(
    "ctdna_val", type=str, required=True, help="ctdna value"
)
update_curated_info_arguments.add_argument(
    "ctdna_opt", type=str, required=True, help="ctdna option"
)

send_json_mtbp_arguments = common_arguments.copy()
send_json_mtbp_arguments.add_argument(
    "user_name", type=str, required=True, help="ctdna value"
)
send_json_mtbp_arguments.add_argument(
    "user_pwd", type=str, required=True, help="ctdna option"
)

rna_common_arguments = reqparse.RequestParser()
rna_common_arguments.add_argument(
    "project_name",
    required=True,
    help="valid Project names: 'PROBIO', 'PSFF', 'LARS_DUCTAL', 'AZ_RINGTRIAL', 'msHSPC', 'RESBIO', 'HD_C3', 'LPC','CHEERS', 'ULLEN', 'CRC_REFLEX','IPCM', 'EVAL_SAMPLES'",
)
...
rna_html_arguments.add_argument(
    "file_name", type=str, required=True, help="sdid example : P-00360714"
)


igv_session_arguments = reqparse.RequestParser()
igv_session_arguments.add_argument(
    "project_name", required=True, help="valid Project names: 'PROBIO', 'PSFF'"
)
igv_session_arguments.add_argument(
    "sdid", type=str, required=True, help="sdid example : P-00360714"
)
...
igv_file_arguments.add_argument(
    "file_name", type=str, required=True, help="sdid example : P-00360714"
)

igv_xml_arguments = reqparse.RequestParser()
igv_xml_arguments.add_argument(
    "file_name", type=str, required=True, help="sdid example : P-00360714"
)
