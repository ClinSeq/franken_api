...
project_arguments.add_argument('project_name', choices=('PROBIO', 'PSFF', 'LARS'), required=True,
                              help="valid Project names: 'PROBIO', 'PSFF', 'LARS'")

capture_arguments = reqparse.RequestParser()
capture_arguments.add_argument('project_name', choices=('PROBIO', 'PSFF', 'LARS'), required=True,
                              help="valid Project names: 'PROBIO', 'PSFF', 'LARS'")
...
common_arguments.add_argument('project_name', choices=('PROBIO', 'PSFF', 'LARS'), required=True,
                              help="valid Project names: 'PROBIO', 'PSFF', 'LARS")
