...
from franken_api.api.franken.business import (
    get_probio_blood_referrals,
    get_psff_blood_referrals,
    get_referrals_information,
    update_referrals,
)
from franken_api.api.franken.parsers import (
    referral_db_arguments,
    referral_update_arguments,
)
from franken_api.api.franken.serializers import (
    probio_ref_data_list,
    psff_ref_data_list,
    referral_db_out,
)
...
class CommonSearchReferral(Resource):
    ...
    def post(self):
        ...
        result, errorcode = get_referrals_information(
            project_name, filter_option, search_pattern
        )
        return result, errorcode
