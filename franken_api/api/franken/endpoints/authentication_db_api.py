...
class RegisterValidation(Resource):
    ...
    def post(self):
        ...
        result, errorcode = form_registation(
            first_name, last_name, email_id, pwd, project_access
        )
        return result, errorcode
